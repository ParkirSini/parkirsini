...
const BookingDetail = () => {
  ...
  const handlePublishReview = () => {
    ...
    if (rating === 0 || reviewText.length < 10) {
      alert("Please provide a rating and a review with at least 140 characters.");
      return;
    }
  ...
  return (
    <>
      <section className="gray-dark booking-details_wrap">
            ...
            <div className="col-md-8 responsive-wrap">
              <div className="booking-checkbox_wrap">
                ...
                <div className="row">
                  ...
                  {relation.FacilityParkings && relation.FacilityParkings.map((facilityParking) => {
                    // Find the corresponding facility using facilityId
                    const facility = facilities.find((f) => f.id === facilityParking.facilityId);
                    ...
                    return (
                      <div className="col-md-4" key={facility.id}>
                        <label className="custom-checkbox">
                          ...
                          <span className="custom-control-description">{facility.name}</span>
                        </label>
                      </div>
                    );
                  })}
        ...
        ></textarea>
                      <h6 className="your-rating-notify">at least 10 characters</h6>
                    </div>

                    <div className="row">
                      <div className="col-md-4">
                        <div className="your-rating-btn">
                          <button className="btn btn-danger btn-block" onClick={handlePublishReview}>
                            Publish Review
                          </button>
                        </div>
                      </div>
                  ...
                  <div className="customer-review_wrap" key={review.id}>
                    ...
                    <div className="customer-content-wrap">
                      <div className="customer-content">
                        ...
                        <div className="customer-rating customer-rating-red">{review.rating}</div>
                      </div>
            ...
            <div className="col-md-4 responsive-wrap">
              <div className="contact-info">
                ...
                <div className="address">
                  ...
                  <p>{relation.Landlord ? relation.Landlord.phoneNumber : ""}</p>
                </div>
                <div className="address">
