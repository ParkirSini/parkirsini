...
const BookingDetail = ({ park }) => {
  function handlePublishReview(id) {
    // create review
  }
  return (
          ...
          <div className="col-md-8 responsive-wrap">
            <div className="booking-checkbox_wrap">
              ...
              <div className="booking-checkbox">
                <p>
                  Layanan sewa lahan parkir yang terbaik, teknologi terbaru dan
                  kebersihan yang terjamin. Kalau kamu punya mobil premium dan
                  butuh tempat yang jamin keamanan mobil kamu, hilangkan resiko
                  mobil tergores atau terbentur dengan adanya space antar satu
                  mobil dengan mobil lainnya.
                </p>
                <p>
                  Fasilitas yang berbeda dengan tempat parkir pada umumnya,
                  pencahayaan yang sangat cukup dan terbebas dari adanya hewan
                  liar membuat kondisi cat selalu dalam kondisi terbaik. Mobil
                  kamu juga akan terbebas dari kejahilan orang, dibandingkan
                  lokasi parkir pada umumnya.
                </p>
                <hr />
              </div>
              <div className="row">
                  ...
                  <div className="row">
                    <div className="col-md-4 mr-auto">
                      <div className="add-photos-link mb-3 mb-md-0">
                        <a href="#">
                          <i className="icon-picture"></i>Add Photos
                        </a>
                      </div>
                    </div>
                    <div className="col-md-4">
                      <div className="your-rating-btn">
                        <button
                          onClick={() => handlePublishReview(park.id)}
          ...
          <div className="col-md-4 responsive-wrap">
            <div className="contact-info">
              ...
              <div className="address">
                ...
                <p>
                  {" "}
                  Jl. Sudirman No. 1<br /> Jakarta Pusat, 10013
