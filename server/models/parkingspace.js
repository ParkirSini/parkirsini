...
module.exports = (sequelize, DataTypes) => {
  class ParkingSpace extends Model {
    ...
    static associate(models) {
      ...
      ParkingSpace.hasMany(models.FacilityParking, { foreignKey: 'parkingSpaceId' });
      ParkingSpace.hasMany(models.ParkingSpaceImage, { foreignKey: 'parkingSpaceId' });
      ParkingSpace.hasMany(models.Booking, { foreignKey: 'parkingSpaceId' });
      ParkingSpace.hasMany(models.ParkingSpaceReview, { foreignKey: 'parkingSpaceId' });
    }
  }
  ParkingSpace.init({
    landlordId: {
